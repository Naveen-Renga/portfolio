          ...
          >
            <div>
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                {"Whether you need a stunning website, a powerful SaaS platform, or a complete digital transformation, we're here to help."}
              </p>
            </div>
            ...
            <div className="space-y-5">
              ...
              >
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-neon-blue/20 to-neon-cyan/20 flex items-center justify-center flex-shrink-0">
              ...
              <motion.a
                ...
                whileHover={{ x: 10, transition: { duration: 0.2 } }}
              >
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-green-500/20 to-green-600/20 flex items-center justify-center flex-shrink-0">
            ...
            <div className="space-y-4">
              <motion.a
                href="#"
                className="inline-block px-6 py-3 rounded-xl bg-secondary/40 border border-border/40 text-muted-foreground hover:text-foreground hover:border-neon-cyan/40 transition-all duration-300 text-sm font-medium"
              ...
              <motion.div
                ...
                className="flex flex-col items-center gap-3 p-4 rounded-2xl bg-card/40 border border-border/40 backdrop-blur-md w-fit"
              >
